...
import LocationSalaryCard from '@/pages/Boss/RecruitSearch/LocationSalaryCard'
import MultiSelectCard from '@/pages/Boss/RecruitSearch/MultiSelectCard'
import RecruitFilterTabs from '@/pages/Boss/RecruitSearch/RecruitFilterTabs'
import SingleSelectCard from '@/pages/Boss/RecruitSearch/SingleSelectCard'
...
function FilterOptions() {
  ...
  return (
    <Page isScrollView={false} conntentStyle={styles.container}>
      <View>
        <RecruitFilterTabs listRef={listRef} data={listData} />
      </View>
