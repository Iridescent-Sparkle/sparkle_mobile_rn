      ...
      <View style={styles.container}>
        ...
        <Visible visible={!loading}>
          ...
          <View style={styles.list}>
            {
              jobList.length
                ? <FlatList data={jobList} renderItem={job => <RecruitListCard data={job.item} />} keyExtractor={item => item.id} onEndReached={onReachBottom} ListFooterComponent={ListFooterComponent()} />
                : (
                  <Space>
                    <FastImage
                      style={styles.banner}
